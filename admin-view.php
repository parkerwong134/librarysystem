                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT books.BookName,tblcategory.CategoryName,tblauthors.AuthorName,books.ISBNNumber,books.BookPrice,tblbooks.id as bookid from books join tblcategory on tblcategory.id=books.CatId join tblauthors on tblauthors.id=books.AuthorId";
$query = $dbh -> prepare($sql);
$query->execute();
